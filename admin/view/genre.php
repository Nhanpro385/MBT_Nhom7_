...
<div id="content">
                        ...
                        <div class="modal-body">
                            <form id="addGenreForm">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="add_genre_name" name="add_genre_name" required>
                                </div>
    ...
    <div class="container-fluid">
        ...
        <p class="mb-4">List of movie genre</p>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <div class="col-md-6 mt-2">
                    <button class="btn btn-success" data-toggle="modal" data-target="#addGenreModal">
...
// $user_data là mảng chứa dữ liệu người dùng
    ...
    foreach ($genres as $genre) {
        ...
        <span class="text">Update info</span>
            ...
            <a href="' . $genre["genre_id"] . '" class="btn btn-danger btn-icon-split">
                <span class="icon text-white-50">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="updateForm">
                        <input type="hidden" name="updateGenreId" id="updateGenreId">
                        <div class="form-group">
                            <label for="updateName">Name:</label>
                            <input type="text" class="form-control" id="updateName" name="updateName" required>
                        </div>
                        <button type="submit" name="btn_update_genre" class="btn btn-primary">Update</button>
                    </form>
                </div>
            </div>
        </div>
...
console.log(name);
        $.ajax({
            ...
            success: function (response) {
                ...
                // Close the modal after successfully sending data
