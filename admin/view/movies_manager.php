                            ...
                            <div class="row">
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="add_movie_name"
                                            name="add_movie_name" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="movie_genre">Genre</label>
                                        <select class="form-control" id="add_movie_genre" name="add_movie_genre"
                                            required>
                                            <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="add_movie_director"
                                            name="add_movie_add" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="actors">actors:</label>
                                        <input type="text" class="form-control" id="add_movie_actors"
                                            name="add_movie_actors" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="duration">duration:</label>
                                        <input type="text" class="form-control" id="add_movie_duration"
                                            name="add_movie_duration" required>
                                    </div>
                                </div>
                                <div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="add_movie_price"
                                            name="add_movie_price" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" id="add_movie_img" name="add_movie_img"
                                            required>
                                    </div>
                                    <div class="form-group">
                                        <label for="add_movie_link">Movie link trailer</label>
                                        <input type="text" class="form-control" id="add_movie_link"
                                            name="add_movie_link" required>
                                    </div>
                                </div>
                            </div>
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Update movie Information</h5>
